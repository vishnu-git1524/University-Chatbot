...
export default function ChatBox(props) {
  ...
  const playSendSound = () => {
    const audio = new Audio("/sound.mp3"); // Specify the correct path to your sound file
    audio.play();
  };
  ...
  return (
    ...
    >
      ...
      <div className="chat-box-middle flex-1 overflow-y-auto" ref={divRef}>
        <div>
      ...
      <div className="chat-box-bottom bg-red-800 h-16 w-full flex items-center justify-center p-3">
        <input
          ...
          onKeyDown={(e) => {
            if (e.key === "Enter") {
                ...
                locked.current = true;
                const messageToSend = chatBoxValue;
                setChatBoxValue("");
                updateChats("client", messageToSend);
                ChatApi.query_request(messageToSend).then(onDataReceived);
                playSendSound();
            }
        }}
        ...
        <button
          ...
          onClick={() => {
            ...
            playSendSound(); // Play sound after sending message
          }}
        >
